$(document).ready(function() {
    ...
    $.getJSON(decodeurl, function(json) {
        ...
        place_id[0] = json.result[0].place_id
        ...
        place_id[1] = json.result[1].place_id
        ...
        place_id[2] = json.result[2].place_id
        ...
        place_id[3] = json.result[3].place_id
        ...
        place_id[4] = json.result[4].place_id
    });
});